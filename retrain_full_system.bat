...
echo [STEP 1/4] Retraining base models...
python scheduler.py
if %errorlevel% neq 0 (
...
echo [STEP 2/4] Generating new history with new features (this will take a long time)...
...
echo [STEP 3/4] Creating new meta-dataset...
...
echo [STEP 4/4] Retraining meta-models on new data...
